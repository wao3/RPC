...
import cn.wao3.rpc.registry.zk.ZkServiceDiscovery;
...
public class ZkServiceRegistryTest {
    ...
    private final ZkServiceDiscovery serviceDiscovery = new ZkServiceDiscovery();
    ...
    public void registerAndDiscover() {
        ...
        List<InetSocketAddress> inetSocketAddresses = Arrays.asList(new InetSocketAddress("127.0.0.1", 8888),
        ...
        for (int i = 0; i < 10; i++) {
            InetSocketAddress discover = serviceDiscovery.discover(rpcRequest);
